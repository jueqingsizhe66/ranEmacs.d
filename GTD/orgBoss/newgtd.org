...
** TODO [#B] 修改静态偏航工况的文章，再投稿 <2018-06-23 周六 11:47>   :学术:
...
4. [-] 负偏航角计算(-30°)
   ...
   3. [ ] 处理结果
** TODO [#A] Fluent双滑移的验证case[0%] <2018-06-25 周一 08:36>          :学术:
DEADLINE: <2018-07-14 周六>
  ...
  2. [-] 选择完网格之后，再进行湍流模型的验证
     ...
     3. [ ] 490w
  3. [ ] 验证完湍流模型之后，为了表示非定常时间步选择的合理性，再考虑使用不同时间步                  
** TODO [#A] 双滑移的数据处理[0%] <2018-06-25 周一 08:38>                :学术:
DEADLINE: <2018-07-03 周二>
                    :PROPERTIES:
                    :Effort: 2:00
                    :END:
                    :LOGBOOK:
                    CLOCK: [2018-06-26 周二 21:28]
...
10. [ ] Free vortex method and BEM (不同偏航角下)
    ...
    2. [ ] BEM
** TODO [#B] 基于多轴角运动的气动特性和流场分析大论文 <2018-06-25 周一 16:19> :学术:
